...
const LESSONS = [
    { id: 'plastics', title: 'Identify Plastic Types', subtitle: 'PET, HDPE, LDPE made simple', duration: '6 min', video: '', content: 'Learn how to recognize common plastic types and their recyclability.' },
    { id: 'recyclable', title: 'What’s Recyclable?', subtitle: 'Yes/No and prep guide', duration: '5 min', video: '', content: 'Know which household items can be recycled and how to prepare them.' },
    { id: 'value', title: 'Market Value Basics', subtitle: 'How segregation increases ₹/kg', duration: '4 min', video: '', content: 'Understand factors that influence waste market rates and your payout.' },
    { id: 'ewaste', title: 'Responsible E‑waste', subtitle: 'Dispose electronics safely', duration: '7 min', video: '', content: 'Learn the right way to dispose of batteries and electronics.' }
];

let learnProgress = { completedLessonIds: [], totalCompleted: 0, totalLessons: LESSONS.length, points: 0 };
